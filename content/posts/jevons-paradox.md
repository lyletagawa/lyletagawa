...
![Why efficiency improvements in technology often increase total consumption rather than reduce it, and how leaders can anticipate and manage the inevitable rebound.](/images/jevons-paradox-jam.jpg)
...
You've just cut your cloud costs by 40%. Six months later, your bill is higher than before. You've made your API 10x faster. Now you're handling 50x more traffic and your infrastructure is buckling. You've deployed AI agents to review every pull request. Merge volume doubles. Your AI compute bill is a line item that you didn't budget for.

Welcome to Jevons Paradox. Make a resource cheaper or faster, and you'll find more ways to use it.

## What Is Jevons Paradox?

In 1865, economist William Stanley Jevons observed that as coal-burning steam engines became more efficient, Britain's coal consumption increased rather than decreased{{< cite 1 "Jevons, William Stanley (1865). The Coal Question. Macmillan and Co." >}}. More efficient engines made coal-powered applications economically viable in new contexts. The result was higher consumption instead of lower{{< cite 2 "Sorrell, Steve (2009). Jevons' Paradox Revisited: The Evidence for Backfire. Energy Policy, 37(4): 1456-1469." >}}.
...
Caching reduces database load by 80%. The freed database capacity gets used for new analytics queries. Database costs stay the same, but you're now supporting workloads that only recently became possible.

## How It Manifests

**The cloud cost spiral.** Azul reported a cloud migration that reduced per-transaction costs by 42%, yet total cloud spend doubled over three years as they processed significantly more transactions and launched services that only recently became viable{{< cite 4 "Sellers, Scott (2025). Why Cloud Efficiency is Driving More IT Spending, Not Less. InformationWeek." >}}.
...
**Plan for rebound.** When optimizing, assume consumption will rise rather than fall.

- Bad Planning: "This optimization will reduce costs by 50%."
- Good Planning: "This optimization will reduce per-unit costs by 50%. Usage is expected to increase 2-3x as new use cases become viable."

**Implement economic constraints.** Efficiency removes natural constraints. Rate limiting, cost chargebacks to teams, quotas, and approval gates for new high-volume use cases put intentional friction back in. Release capacity based on business priorities instead of technical availability{{< cite 8 "Kim, Gene, et al. (2016). The DevOps Handbook. IT Revolution Press." >}}.
...
When your API optimization drives 50x more traffic, that is the product working. New use cases becoming economically viable is how technology markets expand. Framing it as failure misidentifies the goal. When growth was the objective, planning for cost reduction was the real mistake. The rebound simply did its job.
...
**Paradox.** From the Greek "paradoxon," where para means contrary to and doxa means opinion.

**Wirth's Law.** Niklaus Wirth observed that software gets slower faster than hardware gets faster. Hardware efficiency gains are absorbed by software bloat. ([Wirth, 1995](https://people.inf.ethz.ch/wirth/Articles/LeanSoftware.pdf))

**The Katy Freeway.** Houston widened the Katy Freeway to 26 lanes to reduce congestion. Congestion got worse. Traffic engineers call this induced demand. Building more road capacity generates more traffic to fill it. ([Duranton and Turner, 2011](https://www.aeaweb.org/articles?id=10.1257/aer.101.6.2616))
